...
for.cond1.preheader:                              ; preds = %for.inc17, %entry.split
  %indvars.iv34 = phi i64 [ 0, %entry.split ], [ %indvars.iv.next35, %for.inc17 ]
  br label %for.body3
...
for.cond1.preheader:                              ; preds = %for.end, %entry.split
  %indvars.iv26 = phi i64 [ 0, %entry.split ], [ %indvars.iv.next27, %for.end ]
...
for.end:                                          ; preds = %for.inc
  %.lcssa = phi %struct.__sFILE* [ %4, %for.inc ]
...
for.cond1.preheader:                              ; preds = %for.inc28, %entry.split
  %indvar = phi i64 [ 0, %entry.split ], [ %indvar.next, %for.inc28 ]
  br label %for.body3
...
for.inc25:                                        ; preds = %for.body8
  %add.lcssa = phi float [ %add, %for.body8 ]
  store float %add.lcssa, float* %arrayidx5, align 4, !tbaa !4
