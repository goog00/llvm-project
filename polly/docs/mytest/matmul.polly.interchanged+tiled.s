...
LBB2_4:                                 ## %polly.loop_header26
	...
	movaps	(%rdi,%rbx), %xmm15
	movaps	16(%rbx,%r8,4), %xmm14
	movaps	(%r10,%rbx), %xmm13
	movaps	16(%r10,%rbx), %xmm12
	movaps	(%r11,%rbx), %xmm11
	movaps	16(%r11,%rbx), %xmm10
	movaps	(%r14,%rbx), %xmm9
	movaps	16(%r14,%rbx), %xmm8
	movaps	(%r15,%rbx), %xmm7
	movaps	16(%r15,%rbx), %xmm6
	movaps	(%r12,%rbx), %xmm5
	movaps	16(%r12,%rbx), %xmm4
	movaps	(%r13,%rbx), %xmm3
	movaps	16(%r13,%rbx), %xmm2
	movaps	(%rdx,%rbx), %xmm0
	movaps	%xmm0, -80(%rbp)                ## 16-byte Spill
	movaps	16(%rdx,%rbx), %xmm0
	movq	%rax, %rdi
	movl	$0, %r9d
	.p2align	4
...
## %bb.6:                               ## %polly.loop_exit34
	...
	movaps	%xmm15, (%rbx,%r8,4)
	movaps	%xmm14, 16(%rbx,%r8,4)
	movaps	%xmm13, (%rbx,%r10)
	movaps	%xmm12, 16(%rbx,%r10)
	movaps	%xmm11, (%rbx,%r11)
	movaps	%xmm10, 16(%rbx,%r11)
	movaps	%xmm9, (%rbx,%r14)
	movaps	%xmm8, 16(%rbx,%r14)
	movaps	%xmm7, (%rbx,%r15)
	movaps	%xmm6, 16(%rbx,%r15)
	movaps	%xmm5, (%rbx,%r12)
	movaps	%xmm4, 16(%rbx,%r12)
	movaps	%xmm3, (%rbx,%r13)
	movaps	%xmm2, 16(%rbx,%r13)
	movaps	-80(%rbp), %xmm1                ## 16-byte Reload
	movaps	%xmm1, (%rbx,%rdx)
	movaps	%xmm0, 16(%rbx,%rdx)
	incq	%rsi
